...
case class AI3(private val _name: String, private val _shipsGrid: GridOfShips, private val _attackGrid: GridOfAttack, private val _ships: Set[Ship], private val _score: Int = 0, _random: Random) extends Player(_name, _shipsGrid, _attackGrid, _ships, _score) with AI {
